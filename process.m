...
elseif type==1
    ...
    Rtab=array2table(results,'VariableNames',{'ActTime','Vmax','TauFall','APD30','APD80','APDtri','D_F0','F1_F0','CL'});
end
...
elseif type==1
    Mtab=array2table(mean_results,'VariableNames',{'Vmax','TauFall','APD30','APD80','APDtri','D_F0','F1_F0','CL','FD_F0','LD_F0'});
end
